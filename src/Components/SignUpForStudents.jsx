...
export default function SignUpForStudents() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const data = {userEmail:userEmail, section:section, fName:fName, lName:lName, password:password, role:"Student"}
          ...
          >
            <div className="space-y-2">
              ...
              >
                ...
                <option value="3">AD1</option>
                <option value="4">AD2</option>
                <option value="5">G1</option>
                <option value="6">G2</option>
                <option value="7">AF1</option>
                <option value="8">AF2</option>
              </select>
            </div>
